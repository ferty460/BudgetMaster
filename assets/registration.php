...
<head>
    ...
    <meta name="description" content="Зарегистрируйтесь на нашем сервисе для учета доходов и расходов, чтобы получить полный доступ к вашим личным финансовым данным." />
    <link rel="stylesheet" href="css/style.css" />
    <link rel="stylesheet" href="css/reset.css" />
    <link rel="stylesheet" href="css/media.css" />
    <title>Регистрация | БюджетМастер</title>
</head>
        ...
        <main class="main">
            <section class="registration">
                <div class="container">
                    ...
                    <?php flash(); ?>
                    <form action="../service/do-register.php" method="post" class="register-form">
                        <div class="form-item">
                            <label for="username" class="form-label">Введите имя пользователя:</label>
                            <input name="username" type="text" id="username" placeholder="Имя пользователя" class="form-input">
                        </div>
